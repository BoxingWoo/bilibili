...
/** 竖屏控制器 */
@property (nonatomic, weak) LivePortraitMediaControl *portraitMediaControl;
/** 横屏控制器 */
@property (nonatomic, weak) LiveLandscapeMediaControl *landscapeMediaControl;
...
- (LivePortraitMediaControl *)portraitMediaControl
{
    if (!_portraitMediaControl) {
        LivePortraitMediaControl *portraitMediaControl = [[LivePortraitMediaControl alloc] init];
...
- (LiveLandscapeMediaControl *)landscapeMediaControl
{
    if (!_landscapeMediaControl) {
        LiveLandscapeMediaControl *landscapeMediaControl = [[LiveLandscapeMediaControl alloc] init];
...
- (void)refreshMediaControl
{
    if (self.delegatePlayer.isPreparedToPlay) {
        ...
        if (_interfaceOrientationMask == UIInterfaceOrientationMaskPortrait) {
            ...
            self.landscapeMediaControl.model = self.model;
            ...
            self.landscapeMediaControl.handleMoreCommand = self.handleMoreCommand;
